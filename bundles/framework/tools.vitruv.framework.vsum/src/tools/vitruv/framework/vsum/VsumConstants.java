...
public class VsumConstants {
    ...
    public static final String UUID_PROVIDER_AND_RESOLVER_FOLDER_NAME = "uuid";
    ...
    public static final String VAVE_FOLDER_NAME = "vavemodel";
    public static final String VAVE_SYSTEM = "system";
